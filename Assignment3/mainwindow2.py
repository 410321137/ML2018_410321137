...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit.setGeometry(QtCore.QRect(110, 9, 341, 31))
        self.lineEdit.setObjectName("lineEdit")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(20, 9, 81, 31))
        self.label_3.setObjectName("label_3")
        self.pushButton_6 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_6.setGeometry(QtCore.QRect(460, 10, 51, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(_translate("MainWindow", "訓練(SVM)"))
        self.pushButton_4.setText(_translate("MainWindow", "訓練(vote: LR + SVM + GNB)"))
        ...
        self.pushButton_6.setText(_translate("MainWindow", "選擇"))
